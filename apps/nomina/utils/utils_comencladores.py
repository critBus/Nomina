...
def crear_salarios_escalas_default():
    ...
    grupos_complejidad=(
        ("I",("II","III","IV","V","VI",)),
        ("II", ("III", "IV", "V", "VI",)),
        ("III", ("IX", "X", "XI", "XII","XIII","XIV","XV","XVI","XVII",)),
        ("IV", ("XVII", "XVIII", "XIX",)),
        ("V", ("IX", "X", "XI", "XII", "XIII", "XIV", "XV", "XVI", "XVII",)),
        ("IV", ("XVII", "XVIII", "XIX",)),
        ("VI", ("XIX", "XX", "XXI", "XXII", "XXIII", "XXIV", "XXV",),)
                        )
    def get_rango_salarios(rango):
        ...
        for v in datos:
            if v[0] == rango:
                ...
                break
        return respuesta
    def crear_salarios_escalas(grupo_complejidad,rango_salarial,grupo_escala,salario):
    ...
    for complejidad,rangos in grupos_complejidad:
        ...
        for i,v in enumerate(datos_actuales):
            ...
            for j,salario in enumerate(v[1]):
                ...
                rango_salarial=j+1
                crear_salarios_escalas(grupo_complejidad,rango_salarial,grupo_escala,salario)
